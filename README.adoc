...
`blender-evolver.py`:: A script for *Blender* which is designed to export the selected mesh in *Blender* to the data file format of *evolver*. To use it, open the text editor with Shift-F11 in Blender. Open the script and run it with Alt-p.
...
== Links
- https://www.imo.universite-paris-saclay.fr/~labourie/galerie.html[Some nice minimal surfaces to visualize]
